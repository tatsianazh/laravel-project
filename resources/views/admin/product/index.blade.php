                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    <i class="zmdi zmdi-plus"></i><a href="{{route('admin.product.create')}}"> Добавить товар</a></button>
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td>
                                        <div class="table-data-feature">
                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Photo">
                                                <a href="{{route('admin.photo.index', ['product'=>$product])}}"><i class="zmdi zmdi-image"></i></a>
                                            </button>
                                            <button class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                <a href="{{route('admin.product.edit', ['product'=>$product])}}"> <i class="zmdi zmdi-edit"></i></a>
                                            </button>
